    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <DialogContent>
          ...
          <Dialog.Description>
            {profileId ? (
              <div className="border-basil text-basil mx-auto mt-7 flex flex-col items-center justify-center rounded-lg border-2 py-12">
                <div className="flex flex-col items-center justify-center gap-4">
                  <img
                    src="lens-logo.svg"
                    alt=""
                    className="bg-basil border-basil aspect-square h-32 rounded-full border-2 bg-opacity-10 p-2"
                  />
                  <div className="display-font text-xl font-medium uppercase">{handle}</div>
                  {/* profileId */}
                  <div className="border-basil rounded-2xl border-2 px-6 py-1">
                    ProfileId | {profileId}
                  </div>
                  {/* created  */}
                  <div className="border-basil rounded-2xl border-2 px-6 py-1">
              ...
              <div className="flex cursor-pointer flex-col justify-between space-y-4 rounded-xl p-4">
                ...
                <input
                  type="text"
                  placeholder="demo.lens"
                  className="border-basil text-basil bg-peas focus:ring-basil placeholder-basil mx-auto rounded-lg border text-center focus:outline-none focus:ring-1"
                  onChange={(e) => setHandle(e.target.value)}
                />
                <p className="text-basil text-center ">
                  {/* ProfileNFT contains the history of all of the posts, mirrors,
          comments, and other content. */}
                </p>
                <button
                  className="bg-basil text-peas focus:ring-basil mx-auto flex items-center gap-2 rounded-2xl px-6 py-5 uppercase leading-3 focus:ring-1"
