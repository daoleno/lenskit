...
// import { createProfile } from "../../lensapi/profile/create-profile";
...
//             />
//             <div className="uppercase display-font text-xl font-medium">
//               {handle}
//             </div>
//             {/* profileId */}
...
//             className="border mx-auto border-basil text-basil text-center rounded-lg bg-peas focus:ring-1 focus:ring-basil focus:outline-none placeholder-basil"
...
//           </p>
//           <button
//             className="bg-basil px-6 py-5 text-peas rounded-2xl focus:ring-1 focus:ring-basil flex items-center gap-2 mx-auto uppercase leading-3"
