...
// export default function LensPopover() {
...
//                 group inline-flex items-center gap-2 rounded-2xl bg-lime px-6 py-2 font-normal text-basil hover:bg-opacity-80 focus:outline-none`}
//             >
//               <svg
//                 width="16"
//                 height="16"
...
//                 <div className="overflow-hidden rounded-lg shadow-lg bg-peas">
//                   <div className="relative grid gap-8 p-7 lg:grid-cols-2">
//                     {adminActions.map((item) => (
//                       <Popover.Button
//                         key={item.name}
//                         className="-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:ring-1 hover:ring-offset-2 hover:ring-gray-500 cursor-pointer"
//                         as="div"
//                         onClick={item.onClick}
//                       >
//                         <div className="flex h-10 w-10 shrink-0 items-center justify-center text-basil sm:h-12 sm:w-12">
...
//                     ))}
//                   </div>
//                   <div className="p-4 bg-opacity-50 text-basil">
//                     <a
...
//                         </span>
//                       </span>
//                       <span className="block text-sm bg-opacity-50">
...
//                     >
//                       <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-peas p-6 text-left align-middle shadow-xl transition-all">
//                         <div className="w-full flex flex-row justify-between items-center">
//                           <div className="text-basil font-xl uppercase">
//                             {currentModal}
//                           </div>
//                           <XMarkIcon
//                             className="h-6 w-6 text-basil hover:text-opacity-70 cursor-pointer"
//                             onClick={() => setIsOpen(false)}
//                           />
//                         </div>
//                         {currentModal === "Create Profile" && <CreateProfile />}
//                         {currentModal === "Update Profile" && <UpdateProfile />}
//                         {currentModal === "Post" && <Post />}

//                         {currentModal === "Follow" && <Follow />}
//                         {currentModal === "Collect" && <Collect />}
//                         {currentModal === "Mirror" && <Mirror />}
//                       </Dialog.Panel>
//                     </Transition.Child>
//                   </div>
//                 </div>
